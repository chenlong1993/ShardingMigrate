...
class CustomerYamlLoader extends YamlProcessor {

    private final Resource resource;

    CustomerYamlLoader(Resource resource) {
    ...
    private class OriginTrackingConstructor extends Constructor {
        ...
        private Origin getOrigin(Node node) {
            ...
            return new TextResourceOrigin(CustomerYamlLoader.this.resource, location);
        }
